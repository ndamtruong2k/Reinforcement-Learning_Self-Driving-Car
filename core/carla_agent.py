...
from setup import utils, augmentations as aug
from setup import PPOAgent
from setup import PPOMemory
from setup import ThreeCameraCARLAEnvironmentDiscrete
from setup.environments.carla.tools import utils as carla_utils
from setup.parameters import DynamicParameter
        ...
        def augment_fn(states: list):
            ...
            if alpha > 0.0:
                ...
                if aug.tf_chance(seed=seed) < alpha:
                    image = setup.augmentations.simclr.color_jitter(image, strength=alpha, seed=seed)
